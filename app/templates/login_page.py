    ...
    <section class="login-card">
      <div class="hero-copy">
        ...
        <p>
          ...
          Use <code>vera</code> / <code>research123</code> to sign in.
        </p>
      </div>
      <form class="login-form" method="post" action="/login">
        ...
        {error_html}
        <button type="submit">Open Research Notebook</button>
      </form>
    </section>
    """
    return render_layout(title="Research Notebook Login", body=body, page_id="login")
